...
Define a smaller window (*test_window*) inside the main frame window which is the ROI (Region of Interest). Only inside this window the tests will be visible.
